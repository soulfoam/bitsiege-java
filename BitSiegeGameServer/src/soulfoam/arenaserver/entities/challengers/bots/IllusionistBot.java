...
public class IllusionistBot extends Bot{
	
	public IllusionistPassive passive;
	
	public IllusionistBot(float x, float y) {
		
		this.challengerType = Bot.ILLUSIONISTCLASSBOT;
		this.x = x;
		this.y = y;
		
		this.bot = true;
		this.skinID = CosmeticLibrary.ILLUSIONIST_SKIN_NORMAL;
		this.underglowID = -1;
		initAbilities();
